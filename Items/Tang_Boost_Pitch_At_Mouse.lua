--[[
  ...
  reaper.SetEnvelopePoint( env, envPoint, envPosition, 1 * diffY, 0, 1, 0, 0 )
...
reaper.Main_OnCommand(reaper.NamedCommandLookup( "_S&M_TAKEENV10" ), 1 )
...
--if envPoint == -1 then
reaper.InsertEnvelopePoint(env, envPosition, 1, 0, 1, 0, 0 )
